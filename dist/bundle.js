...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _reactDom.render)(_react2.default.createElement(
	  ...
	  _react2.default.createElement(_reactRouter.Route, { path: '/', component: _index.App1 })
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _serenitydi = __webpack_require__(159);
	
	var _serenitydi2 = _interopRequireDefault(_serenitydi);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	function _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }
	
	_serenitydi2.default.registerState(function () {
	  return {
	    items: []
	  };
	}, 'TodoModel', []);
	
	_serenitydi2.default.register(function (model) {
	
	  return function (item) {
	    model.setState({
	      items: [].concat(_toConsumableArray(model.items), [item])
	    });
	  };
	...
	_serenitydi2.default.register(function (model) {
	  ...
	  return function (item) {
	    ...
	    model.setState({
	      items: [].concat(_toConsumableArray(model.items.map(function (existing) {
	        return existing === item ? item : existing;
	      })))
	    });
	  };
	...
	_serenitydi2.default.register(function (model) {
	  ...
	  return function (item) {
	    ...
	    model.setState({
	      items: [].concat(_toConsumableArray(model.items.filter(function (existing) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _injector = __webpack_require__(160);
	
	var injector = {
	  register: _injector.register,
	  registerState: _injector.registerState,
	  fetch: _injector.fetch
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dataWrapper = __webpack_require__(161);
	...
	function register(service, name, dependencies) {
	...
	function runService(serviceName) {
	  var _services$serviceName;
	
	  var injectables = services[serviceName].dependencies.map(function (injectName) {
	    return runService(injectName);
	  });
	
	  return (_services$serviceName = services[serviceName]).service.apply(_services$serviceName, _toConsumableArray(injectables));
	}
	
	function registerState(service, name) {
	  var dataInstance = (0, _dataWrapper2.default)(service());
	  register(function () {
	    return dataInstance;
	  }, name, []);
	}
	...
	function fetch(dependencies) {
	  return dependencies.map(function (serviceName) {
...
/***/ function(module, exports) {
	...
	function observe(dataObject) {
	
	  var observable = _extends({
	    setState: function setState(newState) {
	      var _this = this;
	
	      if ((typeof newState === 'undefined' ? 'undefined' : _typeof(newState)) !== (typeof dataObject === 'undefined' ? 'undefined' : _typeof(dataObject))) {
	        throw 'new state must be of type ' + (typeof dataObject === 'undefined' ? 'undefined' : _typeof(dataObject));
	      }
	
	      Object.keys(newState).forEach(function (key) {
	        return _this[key] = newState[key];
	      });
	...
	function subscribe(observable, func) {
	
	  if (typeof func !== 'function') {
	    throw 'subscriptions must be of type function, Got ' + (typeof func === 'undefined' ? 'undefined' : _typeof(func));
	  }
	...
	function notify(observable) {
	  subscriptions.get(observable).forEach(function (observer) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.TodoList = exports.App1 = exports.TodoItem = undefined;
	
	var _App = __webpack_require__(221);
	
	var _App2 = _interopRequireDefault(_App);
	
	var _serenityReact = __webpack_require__(222);
	
	var _serenityReact2 = _interopRequireDefault(_serenityReact);
	
	var _TodoItem2 = __webpack_require__(224);
	
	var _TodoItem3 = _interopRequireDefault(_TodoItem2);
	...
	exports.TodoItem = _TodoItem3.default;
	var App1 = exports.App1 = (0, _serenityReact2.default)(_App2.default, {
	  'genericAction': 'AddTodoItemAction'
	});
	
	var TodoList = exports.TodoList = (0, _serenityReact2.default)(_TodoList2.default, {
	  'model': 'TodoModel',
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement('input', { value: this.state.inputValue, onChange: this.onChange.bind(this) }),
	        _react2.default.createElement(
	          'button',
	          { type: 'button', onClick: this.onClickEvent.bind(this) },
	          'Add'
	        ),
	        _react2.default.createElement(_index.TodoList, null)
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ReactInjector = __webpack_require__(223);
	
	var _ReactInjector2 = _interopRequireDefault(_ReactInjector);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	exports.default = _ReactInjector2.default;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (WrappedComponent, injectables) {
	
	  return function (_Component) {
	    _inherits(ReactInjectorComponent, _Component);
	
	    function ReactInjectorComponent(props) {
	      _classCallCheck(this, ReactInjectorComponent);
	
	      var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ReactInjectorComponent).call(this, props));
	
	      _this.propsToInject = getPropsFromInjectables(injectables);
	      _this.onUpdate = _this.onUpdate.bind(_this);
	      return _this;
	    }
	
	    _createClass(ReactInjectorComponent, [{
	      key: 'componentDidMount',
	      value: function componentDidMount() {
	        var _this2 = this;
	
	        Object.keys(this.propsToInject).forEach(function (item) {
	          var dependency = _this2.propsToInject[item];
	
	          if (typeof dependency.subscribe === 'function') {
	            dependency.subscribe(_this2.onUpdate);
	          }
	        });
	      }
	    }, {
	      ...
	      value: function onUpdate(data) {
	        this.setState(_extends({}, this.props, data));
	      }
	    }, {
	      key: 'render',
	      value: function render() {
	
	        return (0, _react.createElement)(WrappedComponent, _extends({}, this.props, this.propsToInject));
	      }
	    }]);
	
	    return ReactInjectorComponent;
	  }(_react.Component);
	};
	...
	function getPropsFromInjectables(injectables) {
	  ...
	  var injectKeys = Object.keys(injectables);
	  var injectVals = _serenitydi2.default.fetch(injectKeys.map(function (key) {
	    return injectables[key];
	  }));
	
	  var newProps = injectVals.reduce(function (newProps, dep1, index) {
	...
	var TodoItem = function (_Component) {
	  ...
	  _createClass(TodoItem, [{
	    ...
	    value: function render() {
	      ...
	      var onMarkComplete = _props.onMarkComplete;
	  ...
	  _createClass(TodoList, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'ul',
	        null,
	        model.items.map(function (item, idx) {
	          return _react2.default.createElement(_index.TodoItem, { key: 'todoitem-' + idx, item: item, ref: idx, onMarkComplete: _this2.onMarkComplete.bind(_this2, item), onDelete: _this2.onDelete.bind(_this2, item) });
	        })
	      );
	    }
	  }, {
	    key: 'onDelete',
	    value: function onDelete(idx) {
	      this.props.deleteAction(idx);
	    }
	  }, {
	    key: 'onMarkComplete',
	    value: function onMarkComplete(item) {
